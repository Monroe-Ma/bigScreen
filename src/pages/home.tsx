...
export const Home = () => {
  ...
  return (
    <div className="home">
      <header style={{ backgroundImage: `url(${bg})` }}>成都旅游大数据</header>
      ...
      <main>
        ...
        <section className="section5">
          <div className="bordered row1 crimeType">
            <h2>最热关注点</h2>
            <div className="charts">
              <Chart10 />
              <Chart11 />
          ...
          <div className="bordered row2 crimeStreet">
            <h2>网红打卡点统计</h2>
            <div className="charts">
              <Chart12 />
              <Chart13 />
          ...
          <div className="bordered row3 crimeMeans">
            <h2>投诉事件分析</h2>
            <Chart14 />
          </div>
        </section>
      </main>
      <footer>&copy; MonroeMa 2020-{year}</footer>
    </div>
  )
}
